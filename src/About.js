function About(){
    return (
        ...
        <span className="w-[100%] p-2 md:h-[300px] md:flex items-center text-xs font-semibold md:text-lg text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequuntur iu re h ic explicabo deleniti qui cupiditate nesciunt eum accusantium, quod ad quisquam soluta provident fugit eaque earum illo neque? Facilis earum commodi cumque nam magnam voluptates nihil exercitationem omnis at rerum.</span>
        </div>
