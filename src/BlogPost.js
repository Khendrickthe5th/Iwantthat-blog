        ...
        <div className="w-[100%] h-fit flex justify-center my-[30px]">
            ...
            <div className="w-[100%] h-[fit]">
                <div className="w-full h-fit flex justify-center items-center mb-[10px]">
                    <span  className="w-fit h-fit text-center sm:text-xl font-custom1 font-semibold lg:text-2xl">Blog</span>
                </div>
            </div>
                ...
                <div className="w-[100%] h-fit flex gap-[5px] items-center border-t border-solid border-stone-300">
                    <div className="w-[100px] h-[100px] shrink-0">
                        ...
                        <NavLink to="/Iwantthat-blog/blog/Release001" className="w-[100%] h-fit flex flex-col items-start justify-evenly gap-[10px]">
                            ...
                            <p className="w-fit h-fit text-[0.5rem] text-stone-500 sm:text-[0.7rem] font-semibold italic">Published on 22-05-2023</p>
                    </NavLink>
                </div>
                ...
                <div className="w-[100%] h-fit flex gap-[5px] items-center border-t border-solid border-stone-300">
                    <div className="w-[100px] h-[100px] shrink-0">
                        ...
                        <NavLink to="/Iwantthat-blog/blog/Release002" className="w-[100%] h-fit flex flex-col items-start justify-evenly gap-[10px]">
                            ...
                            <p className="w-fit h-fit text-[0.5rem] text-stone-500 sm:text-[0.7rem] font-semibold italic">Published on 19-05-2023</p>
                    </NavLink>
                </div>
                ...
                <div className="w-[100%] h-fit flex gap-[5px] items-center border-t border-solid border-stone-300">
                    <div className="w-[100px] h-[100px] shrink-0">
                        ...
                        <NavLink to="/Iwantthat-blog/blog/Release003" className="w-[100%] h-fit flex flex-col items-start justify-evenly gap-[10px]">
                            ...
                            <p className="w-fit h-fit text-[0.5rem] text-stone-500 sm:text-[0.7rem] font-semibold italic">Published on 25-05-2023</p>
                    </NavLink>
                </div>
            </div>
        </div>
