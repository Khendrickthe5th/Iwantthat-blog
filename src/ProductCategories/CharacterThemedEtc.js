        ...
        <div className="w-[100%] flex flex-wrap justify-evenly m-0">
            ...
            <div className="w-[100%] h-[fit] p-[15px] my-[20px]">
                <div className="w-full h-fit flex justify-center items-center mb-[10px]">
                    <span  className="w-fit h-fit text-center sm:text-xl font-custom1 font-semibold lg:text-2xl">Character-Themed, Hypebeast, Brand Etc</span>
                </div>
                <p className="w-[100%] h-fit m-auto text-center text-">Design and shop your Character-Themed, Hypebeast, Brand Etc home decor items according to this handpicked list, more items to be added soon!</p>
            </div>
