function CharacterThemedEtc(){
    return(
        <div className="w-[100%] flex flex-wrap justify-evenly m-0">

        <div className="w-[100%] h-[fit] p-[15px] my-[20px]">
            <div className="w-full h-fit flex justify-center items-center">
                <span className="sm:text-xl font-custom1 font-semibold lg:text-2xl"> Character-Themed Etc</span>
            </div>
        </div>
...
export default CharacterThemedEtc;